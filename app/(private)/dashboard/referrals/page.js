        ...
        return (
            <>
                ...
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="max-w-5xl mx-auto pt-20 pb-16 lg:pt-32 lg:pb-24 px-4 lg:px-8 flex flex-col gap-20"
                >
                    {/* Hero Section */}
                    <div className="relative text-center lg:text-left flex flex-col lg:flex-row lg:items-end justify-between gap-10">
                        <div className="max-w-3xl">
                            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[10px] font-black uppercase tracking-[0.4em] mb-8 shadow-[0_0_20px_rgba(59,130,246,0.1)]">
                                <Zap className="w-3.5 h-3.5 text-blue-400 animate-pulse" /> Partner Program 2.0
                            </div>
                            <h1 className="text-3xl lg:text-5xl pro-heading text-white mb-8 leading-[1.1]">
                                SCALE WITH THE <br />
                                <span className="text-gray-500 font-light pr-4">WEBSTACK</span>
                                <span className="text-blue-500 italic relative inline-block">
                                    NETWORK
                                    <div className="absolute -bottom-2 left-0 w-full h-1.5 bg-blue-600/20 blur-sm rounded-full"></div>
                                </span>
                            </h1>
                            <p className="pro-subtext text-base lg:text-xl max-w-2xl text-gray-400 font-medium leading-relaxed">
                                Join an elite circle of digital ambassadors. Refer talent to Africa&apos;s premier technology academy and unlock high-ticket commission protocols.
                            </p>
                        </div>
                        <div className="hidden lg:block pb-5">
                            <div className="flex items-center gap-3 px-6 py-3 rounded-2xl bg-white/[0.02] border border-white/5 backdrop-blur-xl">
                                <div className="w-2 h-2 rounded-full bg-amber-500 animate-pulse"></div>
                                <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Protocol Syncing</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-20">
                        {[
                            { title: "TIERED REWARDS", desc: "Access high-ticket commission structures that scale directly with your network volume.", icon: Coins, color: "text-emerald-400", bg: "bg-emerald-500/10", border: "border-emerald-500/20" },
                            { title: "INSTANT SETTLEMENT", desc: "Automated payout protocols ensure direct settlement to global or local assets.", icon: Zap, color: "text-blue-400", bg: "bg-blue-500/10", border: "border-blue-500/20" },
                            { title: "ELITE ANALYTICS", desc: "Real-time network telemetry and lead tracking through our advanced dashboard.", icon: Trophy, color: "text-purple-400", bg: "bg-purple-500/10", border: "border-purple-500/20" }
                        ].map((item, i) => (
                            <motion.div
                                key={i}
                                ...
                                className="premium-card p-10 group hover:bg-white/[0.04] transition-all duration-700 border-white/5 relative overflow-hidden"
                            >
                                <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-white/5 to-transparent"></div>
                                <div className={`w-14 h-14 ${item.bg} ${item.border} border rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 group-hover:rotate-6 transition-all duration-700 shadow-inner`}>
                                    <item.icon className={`w-7 h-7 ${item.color}`} />
                                </div>
                                <h3 className="text-white font-black text-lg mb-4 tracking-tight uppercase">{item.title}</h3>
                    ...
                    <div className="flex justify-center relative">
                        ...
                        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-amber-500/5 blur-[100px] rounded-full pointer-events-none -z-10"></div>
                        ...
                        {affiliate_status === 'pending' ? (
                            <motion.div
                                ...
                                className="premium-card !p-1 max-w-4xl w-full border-amber-500/20 bg-amber-500/[0.02] backdrop-blur-3xl group/pending"
                            >
                                <div className="rounded-[1.9rem] p-12 lg:p-28 text-center relative overflow-hidden">
                                    ...
                                    <div className="w-24 h-24 bg-amber-500/10 rounded-3xl flex items-center justify-center mx-auto mb-12 relative group-hover/pending:scale-105 transition-transform duration-700">
                                        <Clock className="w-12 h-12 text-amber-500 animate-[spin_10s_linear_infinite]" />
                                        <div className="absolute inset-[-8px] border border-amber-500/10 rounded-3xl animate-pulse"></div>
                                    </div>

                                    <h3 className="text-3xl lg:text-5xl pro-heading text-white mb-8 uppercase tracking-tight">
                                        Verification <span className="text-amber-500 italic">In Progress</span>
                                    </h3>

                                    <p className="text-gray-400 text-base lg:text-xl mb-20 max-w-2xl mx-auto leading-relaxed font-medium">
                                        Our executive review board is currently evaluating your partner application. Access to the full telemetry and settlement suite will be granted upon protocol activation.
                                    </p>

                                    <div className="flex flex-col sm:flex-row items-center justify-center gap-12 sm:gap-32 pt-20 border-t border-white/5">
                                        <div className="text-center">
                                            <div className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-4">Est. Wait Time</div>
                                            <div className="text-3xl font-black text-white font-mono tracking-tighter">12-24 HOURS</div>
                                        </div>
                                        <div className="w-px h-16 bg-white/10 hidden sm:block"></div>
                                        <div className="text-center">
                                            <div className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-4">Protocol Status</div>
                                            <div className="text-emerald-500 text-xs font-black uppercase tracking-widest flex items-center gap-3">
                            ...
                            <motion.div
                                initial={{ scale: 0.98, opacity: 0 }}
                                animate={{ scale: 1, opacity: 1 }}
                                className="premium-card p-12 lg:p-20 text-center max-w-2xl w-full border-red-500/20 bg-red-500/[0.02] backdrop-blur-2xl"
                            >
                                <div className="w-24 h-24 bg-red-500/10 rounded-3xl flex items-center justify-center mx-auto mb-10 relative">
                                    <AlertCircle className="w-12 h-12 text-red-500" />
                                    <div className="absolute inset-0 bg-red-500/20 rounded-full blur-[40px] opacity-30"></div>
                                </div>
                                <h3 className="text-4xl pro-heading text-white mb-6 uppercase tracking-tight">Application <span className="text-red-500">Declined</span></h3>
                                <p className="text-gray-400 text-lg mb-10 italic leading-relaxed font-medium">
                                    &quot;Quality is never an accident; it is always the result of intelligent effort.&quot;
                                </p>
                                <p className="text-gray-500 text-sm mb-12 max-w-md mx-auto leading-relaxed">
                                    Your application does not meet our current partnership criteria. You may re-initialize the request in 30 days.
                                </p>
                                <button
                                    onClick={() => window.location.href = 'mailto:support@webstackict.com'}
                                    className="inline-flex items-center gap-3 text-white hover:text-blue-400 text-[10px] font-black uppercase tracking-[0.3em] transition-all border-b-2 border-white/5 hover:border-blue-400/40 pb-2"
                                >
                            ...
                            <button
                                ...
                                className="group relative bg-blue-600 hover:bg-blue-500 text-white font-black px-16 py-8 rounded-2xl transition-all shadow-[0_25px_60px_rgba(59,130,246,0.4)] hover:shadow-[0_30px_70px_rgba(59,130,246,0.6)] active:scale-95 flex items-center justify-center gap-6 text-2xl tracking-[0.1em] border border-blue-400/30 overflow-hidden"
                            >
                                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                                <span className="relative">INITIALIZE PARTNERSHIP</span>
                                <ChevronRight className="w-8 h-8 group-hover:translate-x-3 transition-transform relative" />
                            </button>
                        )}
                    </div>
                </motion.div>
    ...
    return (
        <>
            ...
            >
                ...
                <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-[400px] h-[200px] bg-blue-600/5 blur-[80px] rounded-full pointer-events-none -z-10 animate-pulse"></div>
                ...
                <motion.div variants={itemVariants} className="flex flex-col lg:flex-row lg:items-center justify-between gap-10 mb-12 relative overflow-hidden p-8 lg:p-12 rounded-[2.5rem] bg-white/[0.02] border border-white/5 backdrop-blur-sm group/hero">
                    ...
                    <div className="absolute top-0 right-0 w-64 h-64 bg-blue-500/[0.02] blur-[60px] rounded-full -mr-20 -mt-20 group-hover/hero:bg-blue-500/5 transition-colors duration-700"></div>
