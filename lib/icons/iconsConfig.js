...
const lazy = (importFn) => dynamic(importFn, { ssr: false, loading: IconLoader });
...
export const iconsConfig = {
  ...
  badgeCheck: lazy(() => import("@mui/icons-material/Verified")),
  laptopCode: lazy(() => import("@mui/icons-material/Laptop")),
  "laptop-code": lazy(() => import("@mui/icons-material/Laptop")),
  ...
  share: lazy(() => import("lucide-react").then((m) => ({ default: m.Share2 }))),
  figma: lazy(() => import("lucide-react").then((m) => ({ default: m.Figma }))),
};
